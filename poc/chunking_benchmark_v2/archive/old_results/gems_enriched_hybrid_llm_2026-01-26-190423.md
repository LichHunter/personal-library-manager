...
**Date**: 2026-01-26T19:04:23.023919
**Queries Tested**: 15
...
5. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_20, score: 0.200]
   > ### Monitoring & Alerting
   > 
...
**Retrieved Chunks**:
1. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_6, score: 1.000]
   > ### Grafana Dashboards
   > 
...
2. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_19, score: 0.500]
...
3. [doc_id: user_guide, chunk_id: user_guide_mdsem_12, score: 0.333]
   > ## Error Handling
   > 
...
5. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_5, score: 0.200]
...
2. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_13, score: 0.500]
...
4. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_17, score: 0.250]
...
2. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_21, score: 0.500]
   > ## Disaster Recovery
   > 
   > 
   > 
...
5. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_24, score: 0.200]
   > ### Testing & Validation
   > 
   > **DR Drill Schedule**:
...
**Retrieved Chunks**:
1. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_5, score: 1.000]
   > ### Prometheus Setup
   > 
...
2. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_2, score: 0.500]
...
4. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_2, score: 0.250]
   > ### Required Tools
   > 
...
5. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_22, score: 0.200]
   > ### High Availability Architecture
   > 
   > **Multi-AZ Deployment**:
   > ```
...
2. [doc_id: user_guide, chunk_id: user_guide_mdsem_15, score: 0.500]
   > ### Execution Limits
   > 
...
**Retrieved Chunks**:
1. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_4, score: 1.000]
   > ### Auth Service
   > 
   > **Purpose**: Centralized authentication and authorization service handling user identity, token generation, and permission validation.
   > 
...
4. [doc_id: api_reference, chunk_id: api_reference_mdsem_3, score: 0.250]
   > ### JWT Tokens
   > 
   > For advanced use cases, CloudFlow supports JSON Web Tokens (JWT) with RS256 signing algorithm. JWTs must include the following claims:
   > 
...
5. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_11, score: 0.200]
   > ### Redis Caching Layer
   > 
   > **Cluster Configuration**:
   ...
   >    - Invalidation: On logout or password...
...
**Retrieved Chunks**:
1. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_8, score: 1.000]
   > # network-policy.yaml
   > 
...
2. [doc_id: api_reference, chunk_id: api_reference_mdsem_1, score: 0.500]
   > ## Authentication
   > 
...
4. [doc_id: user_guide, chunk_id: user_guide_mdsem_16, score: 0.250]
   > ### Data Limits
   > 
   > - **Maximum request/response size**: 10MB per action
   > - **Maximum execution payload**: 50MB total
...
4. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_8, score: 0.250]
...
5. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_3, score: 0.200]
   > # Check database slow query log
   > 
   > kubectl logs -n cloudflow deploy/cloudflow-db-primary | \
   >   grep "slow query" | \
...
**Retrieved Chunks**:
1. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_9, score: 1.000]
   > #### SEV-2: High (P2)
   > 
...
2. [doc_id: architecture_overview, chunk_id: architecture_overview_mdsem_20, score: 0.500]
   > ### Monitoring & Alerting
   > 
   > **Key Metrics** (Monitored via Prometheus):
   > - Request rate (per service, per endpoint)
...
4. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_7, score: 0.250]
