...
Splits documents by markdown headings. Each section (content under a heading)
becomes one chunk. Preserves semantic boundaries but produces variable-sized chunks.
