...
**Date**: 2026-01-26T19:18:26.915577
**Queries Tested**: 10
...
3. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_5, score: 0.333]
...
5. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_11, score: 0.200]
...
4. [doc_id: api_reference, chunk_id: api_reference_mdsem_0, score: 0.250]
...
5. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_1, score: 0.200]
   > ## Overview
   > 
...
4. [doc_id: user_guide, chunk_id: user_guide_mdsem_12, score: 0.250]
   > ## Error Handling
   > 
...
5. [doc_id: user_guide, chunk_id: user_guide_mdsem_17, score: 0.200]
   > ### 8. Test Thoroughly
   > 
   > Before activating a workflow:
   > 1. Use test mode with sample data
...
2. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_11, score: 0.500]
   > #### Step 2: Gather Information (5-15 minutes)
   > 
   > Create incident document with:
   > - Incident timestamp and duration
...
2. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_4, score: 0.500]
...
3. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_1, score: 0.333]
   > ## Overview
   > 
   > CloudFlow is a cloud-native workflow orchestration platform designed for high-availability production environments. This guide provides comprehensive instructions for deploying and operating CloudFlow on Amazon EKS (Elastic Kubernetes Service).
   > 
...
4. [doc_id: troubleshooting_guide, chunk_id: troubleshooting_guide_mdsem_4, score: 0.250]
   > # Create sub-workflows
   > 
   > cloudflow workflows create data-pipeline-part1 \
   >   --steps "data_ingestion,data_validation" \
...
**Retrieved Chunks**:
1. [doc_id: deployment_guide, chunk_id: deployment_guide_mdsem_3, score: 1.000]
